...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="<?php echo $URL;?>/public/index2.html" class="h1"><b>SIS </b>INVENTARIO</a>
        </div>
        <div class="card-body">
            <center> <img src="https://cdn-icons-png.flaticon.com/512/2897/2897785.png"  width="150"></center>
            <br>
            ...
            <form action="controller_login.php" method="post">
                ...
                <div class="row">
                    ...
                    <a href="#" class="btn btn-default btn-block">Registrarse</a>
